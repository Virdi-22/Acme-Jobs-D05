...
@Service
public class AdministratorInvestorRecordShowService implements AbstractUpdateService<Administrator, InvestorRecord> {
	...
	public void unbind(final Request<InvestorRecord> request, final InvestorRecord entity, final Model model) {
		...
		request.unbind(entity, model, "name", "sector", "text", "stars");
