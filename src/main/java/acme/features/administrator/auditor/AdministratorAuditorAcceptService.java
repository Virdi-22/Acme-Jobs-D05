...
@Service
public class AdministratorAuditorAcceptService implements AbstractUpdateService<Administrator, Auditor> {
	...
	public void update(final Request<Auditor> request, final Auditor entity) {
		...
		userAccount = this.repository.findOneUserAccountByAuditorId(auditorId);
