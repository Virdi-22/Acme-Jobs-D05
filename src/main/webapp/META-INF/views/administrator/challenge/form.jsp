...
<acme:form>
	...
	<acme:form-money placeholder="EUR 100" code="administrator.challenge.form.label.bronzeReward" path="bronzeReward"/>
	<acme:form-textarea code="administrator.challenge.form.label.silverGoal" path="silverGoal"/>
	<acme:form-money placeholder="EUR 200" code="administrator.challenge.form.label.silverReward" path="silverReward"/>
	<acme:form-textarea code="administrator.challenge.form.label.goldGoal" path="goldGoal"/>
	<acme:form-money placeholder="EUR 300" code="administrator.challenge.form.label.goldReward" path="goldReward"/>
